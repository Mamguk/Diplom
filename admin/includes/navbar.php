            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="service_price_list.php">Стоимость услуг</a>
                        <a class="collapse-item" href="detail.php">Детали</a>
                        <a class="collapse-item" href="detail_price_list.php">Стоимость деталей</a>
                      </div>
                </div>
            </li>
