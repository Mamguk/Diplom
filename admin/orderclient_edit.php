    ...
    ?>
        ...
        <form action="code.php" method="POST">
                        ...
                        <select name="idstatus" class="form-control" required>
                            <option value="">Выберите статус заказа</option>
                                <?php
                                    ...
                                    {
                                ?>
                            <option value="<?php echo $row['idstatus']; ?>" <?php if($row['idstatus'] == $rowediting['idstatus']) echo 'selected'; ?>><?php echo $row['status']; ?></option>
                                <?php
                                    }
                                ?>
                        </select>
                        ...
                        <select name="idworker" class="form-control" required>
                            <option value="">Выберите мастера</option>
                                <?php
                                    ...
                                    {
                                ?>
                                  <option value="<?php echo $row['idworker']; ?>" <?php if($row['idworker'] == $rowediting['idworker']) echo 'selected'; ?>><?php echo $row['worker']; ?></option>                                <?php
                                    }
                                ?>
                        </select>
                    </div>
                    ...
                    <select name="idauto" class="form-control" required>
                        <option value="">Выберите номер автомобиля</option>
                            <?php
                                ...
                                {
                            ?>
                                <option value="<?php echo $row['idauto']; ?>" <?php if($row['idauto'] == $rowediting['idauto']) echo 'selected'; ?>><?php echo $row['number']; ?></option>                            <?php
                                }
                            ?>
                    </select>
                </div>
                    ...
                    <select name="idclient" class="form-control" required>
                        <option value="">Выберите клиента</option>
                            <?php
                                ...
                                {
                            ?>
                              <option value="<?php echo $row['idclient']; ?>" <?php if($row['idclient'] == $rowediting['idclient']) echo 'selected'; ?>><?php echo $row['client']; ?></option>                            <?php
                                }
                            ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea name="comment" class="form-control" rows="2"><?php echo $rowediting['comment']; ?></textarea>
            </div>
