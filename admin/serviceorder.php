        ...
        <tr>
            ...
            <td>
                <form action="serviceorder_edit.php" method="POST">
                    <input type="hidden" name="serviceorder_edit_id" value="<?php echo $row['min_serviceorder'] ?>" >
                    <button type="submit" name="serviceorder_edit_data_btn" class="btn btn-success">Изменить</button>
                </form>
            </td>
            <td>
                <form action="code.php" method="POST">
                    <input type="hidden" name="serviceorder_delete_id" value="<?php echo $row['min_serviceorder'] ?>">
