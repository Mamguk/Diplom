            ...
            <form action="code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($marka_run) > 0)
                        {
                            ?>
                            <div class="form-group">
                                ...
                                <select name="idmarka" class="form-control" required>
                                    <option value="">Выберите марку авто</option>
                                        <?php
                                            foreach($marka_run as $row)
                                            {
                                        ?>
                                    <option value="<?php echo $row['idmarka']; ?>"><?php echo $row['name']; ?></option>
                                        <?php
                                            }
                                        ?>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="model" class="form-control" placeholder="Введите модель авто" required>
                    </div>
...
<div class="container-fluid">
    ...
    ?>
        <div class="table-responsive">
            ...
            $query = "SELECT auto.*, marka.name AS marka_name FROM auto LEFT JOIN marka ON auto.idmarka = marka.idmarka";
